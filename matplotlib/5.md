...
# 総合課題
まずは[ここ](https://aquilaneo.github.io/GitHubPages/samples/sample1.txt)から使用するテキストファイルをダウンロードし、「sample4.txt」という名前でPythonソースファイルと同じ場所に保存してください。<br>
